...
////                return ObjectIntrinsics.equals(key, e.getKey()) &&
////                        ObjectIntrinsics.equals(value, e.getValue());
////            }
////            return false;
////        }
////    }
...
////    @Override
////    public void clear() {
////        table = CollectionIntrinsics.generateObjectArray(table.length, index -> null);
////        size = 0;
////    }
////
////    @Override
////    public boolean containsValue(Object value) {
////        Object[] values = CollectionIntrinsics.generateObjectArray(table.length, i -> table[i].value);
////        return CollectionIntrinsics.contains(values, value);
////    }
////
////    @Override
////    public Set<K> keySet() {
////        HashSet<K> ks = new HashSet<>();
////        ks.inner.elementData = CollectionIntrinsics.generateObjectArray(size, index -> {
...
////        vs.elementData = CollectionIntrinsics.generateObjectArray(size, index -> {
...
////        ks.inner.elementData = CollectionIntrinsics.generateObjectArray(size, index -> table[index]);
////        return ks;
////    }
////
////    @Override
...
////        m.table = CollectionIntrinsics.generateObjectArray(table.length, i -> table[i]);
////        m.size = size;
////        return m;
////    }
//}